...
function SurveyBuilderScreen({ surveyId, onNavigate }) {
  ...
  return (
    <WorkbenchShell
      ...
      {previewOpen && (
        <window.SurveyPreviewPane draft={draft} onClose={() => setPreviewOpen(false)} />
      )}

      {launchOpen && (
        <window.LaunchValidationModal
          draft={draft}
          issues={launchIssues}
          canLaunch={canLaunch}
...
Object.assign(window, { SurveyBuilderScreen, BUILDER_FIXTURES });
