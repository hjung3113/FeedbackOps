...
CREATE FUNCTION "survey"."read_survey_response_ids"(p_workspace_id uuid, p_survey_id uuid)
...
--> statement-breakpoint
ALTER FUNCTION "survey"."read_survey_response_ids"(uuid, uuid) OWNER TO fops_survey_evidence_reader_owner;
--> statement-breakpoint
...
--> statement-breakpoint
REVOKE ALL ON FUNCTION "survey"."read_survey_response_ids"(uuid, uuid) FROM PUBLIC;
--> statement-breakpoint
GRANT EXECUTE ON FUNCTION "survey"."read_approved_result_excerpts_personal"(uuid, uuid) TO fops_app;
--> statement-breakpoint
GRANT EXECUTE ON FUNCTION "survey"."read_survey_response_ids"(uuid, uuid) TO fops_app;
--> statement-breakpoint
RESET ROLE;
