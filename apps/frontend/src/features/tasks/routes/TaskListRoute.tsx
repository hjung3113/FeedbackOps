        ...
        <div data-anchor="properties" className="border-t border-border-subtle py-2">
          ...
          <FieldRow label="Assignee">
            {task.assignee_actor_id ? (
              <span className="font-mono text-xs">{shortId(task.assignee_actor_id)}</span>
            ) : (
          ...
          <FieldRow label="Managed System">
            <ManagedSystemPill name={shortId(task.primary_managed_system_id)} />
          </FieldRow>
        </div>
          ...
          {source?.finding ? (
            <div className="mt-2 flex flex-col gap-2 rounded-sm border border-border-subtle bg-surface-card p-3">
              ...
              <div className="text-sm font-medium text-text-primary">
                <span className="mr-2 font-mono text-xs text-accent-info">
            ...
            <ObjectRow
              ...
              meta={
                <>
                  ...
                  {dot()}
                  <span>{task.assignee_actor_id ? shortId(task.assignee_actor_id) : 'Unassigned'}</span>
                  {dot()}
