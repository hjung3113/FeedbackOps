...
export const PACK_17_TOKENS: TokenEntry[] = [
  ...
  { tokenName: '--text-on-accent', raw: '#ffffff' },

  // --- Surface tokens ---
  { tokenName: '--surface-canvas',        raw: 'var(--color-pitch-black)' },
  { tokenName: '--surface-sidebar',       raw: '#eef4fb' },
  { tokenName: '--surface-list',          raw: 'var(--color-pitch-black)' },
  { tokenName: '--surface-row-hover',     raw: '#e7effc' },
  { tokenName: '--surface-row-selected',  raw: '#d8e7fb' },
  ...
  { tokenName: '--surface-field-filled',  raw: '#ffffff' },
  { tokenName: '--surface-blocked',       raw: '#eef2f7' },
  ...
  { tokenName: '--severity-high',      raw: '#f08a4a' },
